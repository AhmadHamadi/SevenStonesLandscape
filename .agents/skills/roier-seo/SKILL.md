...
```bash
cd ~/.Codex/skills/roier-seo/scripts
npm install
```
...
For a **live website**:
```bash
node ~/.Codex/skills/roier-seo/scripts/audit.js https://example.com
```

For a **local dev server** (must be running):
```bash
node ~/.Codex/skills/roier-seo/scripts/audit.js http://localhost:3000
```
...
node ~/.Codex/skills/roier-seo/scripts/audit.js https://example.com --output=summary

# Save to file
node ~/.Codex/skills/roier-seo/scripts/audit.js https://example.com --save=results.json
```
...
```bash
node ~/.Codex/skills/roier-seo/scripts/audit.js <URL>
```
